...
public sealed class UnreadablePackMemberTests : IDisposable
{
    ...
    public async Task A_Member_That_Becomes_Unreadable_Is_Excluded_And_The_Pack_Is_Recompressed()
    {
        ...
        var orchestrator = new BackupOrchestrator(
            ...
            new RetentionCleaner(factory, store, new RetentionEvaluator(), compactor, indexCache: authority.IndexCache, trackedInfo: authority.Tracked), flaky, authority.Catalogs, authority.Tracked,
